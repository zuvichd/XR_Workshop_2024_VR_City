...
public class MyXRRightControllerHandler : MonoBehaviour
{
	[SerializeField] 
	private InputActionAsset inputActionAsset;

	[SerializeField] 
	private SceneController SceneControllerRef;
	...
	private void Awake()
	{
		...
		var actionMap = inputActionAsset.FindActionMap("MyRightHandMapping");
